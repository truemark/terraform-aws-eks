...
| <a name="module_monitoring"></a> [monitoring](#module\_monitoring) | truemark/eks-monitoring/aws | 0.0.4 |
...
| <a name="input_cluster_version"></a> [cluster\_version](#input\_cluster\_version) | Kubernetes `<major>.<minor>` version to use for the EKS cluster (i.e.: `1.24`) | `string` | `"1.23"` | no |
