...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cert_manager"></a> [cert\_manager](#module\_cert\_manager) | truemark/eks-certmanager/aws | 0.0.4 |
...
| <a name="module_monitoring"></a> [monitoring](#module\_monitoring) | truemark/eks-monitoring/aws | ~> 0.0.15 |
...
| <a name="input_amp_alerting_rules_exclude_namespace"></a> [amp\_alerting\_rules\_exclude\_namespace](#input\_amp\_alerting\_rules\_exclude\_namespace) | Namespaces to exclude from alerting | `string` | `""` | no |
...
| <a name="input_karpenter_nodepool_default_expireAfter"></a> [karpenter\_nodepool\_default\_expireAfter](#input\_karpenter\_nodepool\_default\_expireAfter) | The amount of time a Node can live on the cluster before being removed | `string` | `"720h"` | no |
...
| <a name="input_karpenter_settings_featureGates_drift"></a> [karpenter\_settings\_featureGates\_drift](#input\_karpenter\_settings\_featureGates\_drift) | Enable or disable drift feature of karpenter | `bool` | `true` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_amp_workspace_id"></a> [amp\_workspace\_id](#output\_amp\_workspace\_id) | The ID of the AMP workspace |
